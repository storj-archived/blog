...
The ACL model, sometimes referred to as the [Ambient Authority Model](https://wikivisually.com/wiki/Ambient_authority),  is based on user identity privileges (for example, through[R](https://en.wikipedia.org/wiki/Role-based_access_control)ole-based Access Control). 
